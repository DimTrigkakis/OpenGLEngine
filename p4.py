...
def Animate(timeval):
	...
	global forward_step, right_step, backward_step,mouse_x,mouse_y, once,scale, waveTime, program, program2, text
	...
	myGate.find_gobject("snow").location = (x+5,y-10,z)
...
textures = ["grass.jpg","starnight.jpg","water.jpg"]
